...
class UserProfileViewController: BaseViewController {
    ...
    private let updateEHBtn = UIButton()
    ...
    override func viewDidLoad() {
        ...
        updateEHBtn.setTitle("Update E-Health Profile", for: .normal)
        updateEHBtn.setTitleColor(.white, for: .normal)
        updateEHBtn.backgroundColor = kPrimaryColor
        updateEHBtn.layer.cornerRadius = 8
        updateEHBtn.addTarget(self, action: #selector(updateEHButtonTapped), for: .touchUpInside)
        self.view.addSubview(updateEHBtn)
        updateEHBtn.snp.makeConstraints { make in
        ...
        signOutBtn.snp.makeConstraints { make in
            make.top.equalTo(updateEHBtn.snp.bottom).offset(20)
            make.width.equalToSuperview().offset(-40)
            make.centerX.equalToSuperview()
            make.height.equalTo(50)
        }
    ...
    @objc private func updateEHButtonTapped() {
