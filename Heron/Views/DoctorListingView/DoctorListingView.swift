...
//  Heron
//
//  Created by Lucas on 1/7/23.
//

import UIKit

protocol DoctorListingViewDelegate : AnyObject {
    func bookNow(_ data: DoctorDataSource)
}

class DoctorListingView: UIView {
    ...
    private var dataSource          : DoctorDataSource?
    var delegate                    : DoctorListingViewDelegate?
